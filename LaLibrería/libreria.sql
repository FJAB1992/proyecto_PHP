...
CREATE TABLE IF NOT EXISTS `libros` (
    `id_libro` int NOT NULL AUTO_INCREMENT, `titulo` varchar(100) NOT NULL, `autor` varchar(100) NOT NULL, `genero` varchar(100) NOT NULL, `fecha_publicacion` date NOT NULL, `disponibilidad` tinyint(1) NOT NULL, `prestamo` int DEFAULT NULL, PRIMARY KEY (`id_libro`)
...
INSERT INTO
    `libros` (
        `id_libro`, `titulo`, `autor`, `genero`, `fecha_publicacion`, `disponibilidad`, `prestamo`
    )
VALUES (
...
CREATE TABLE IF NOT EXISTS `seguridad` (
    `contraseña` varchar(100) NOT NULL, PRIMARY KEY (`contraseña`)
...
INSERT INTO `seguridad` (`contraseña`) VALUES ('JqtSV0Sk');
...
CREATE TABLE IF NOT EXISTS `usuarios` (
    `id_usuario` int NOT NULL AUTO_INCREMENT, `nombre` varchar(100) NOT NULL, `email` varchar(100) NOT NULL, `contraseña` varchar(100) NOT NULL, `rol` varchar(10) NOT NULL, PRIMARY KEY (`id_usuario`)
